    ...
    for i, subject_id in enumerate(tqdm(demographic['Image_ID'])):
        ...
        for i_repetition in range(n_repetitions):
            for i_fold in range(n_folds):
                ...
                weights_img = weights_img.get_fdata()#TODO: use mask affine on comparison_voxel_data_svm_primal_weights.py
                weights_img = nib.Nifti1Image(weights_img, mask_img.affine)#TODO: use mask affine on comparison_voxel_data_svm_primal_weights.py
