...
def main():
    ...
    # For the smallest number of pair, create a out-of-bag set (~test set) with same size of training set
    for i_n_subject_pairs in range(1, n_max_pair//2):
        ...
        for i_bootstrap in range(n_bootstrap):
            ...
            for age in range(age_min, (age_max + 1)):
                ...
                for gender in range(2):
                    ...
                    dataset_bootstrap_train = pd.concat([dataset_bootstrap_train, pd.DataFrame(random_sample_train['Participant_ID'])])
                    ...
                    dataset_bootstrap_test = pd.concat([dataset_bootstrap_test, pd.DataFrame(random_sample_test['Participant_ID'])])
    ...
    for i_n_subject_pairs in range((n_max_pair//2) + 1, n_max_pair+1):
        print(i_n_subject_pairs)
        ids_with_n_subject_pairs_dir = bootstrap_dir / '{:02d}'.format(i_n_subject_pairs)
        ids_with_n_subject_pairs_dir.mkdir(exist_ok=True)
        ids_dir = ids_with_n_subject_pairs_dir / 'ids'
